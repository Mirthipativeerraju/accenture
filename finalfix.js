...
for (let i = 0; i < lines.length; i++) {
    if (lines[i].includes('className={elative flex items-center justify-center font-bold text-lg sm:text-xl transition-all duration-200 active:scale-95 cursor-pointer focus:outline-none \\}')) {
